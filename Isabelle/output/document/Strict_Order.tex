...
\ \ \isacommand{by}\isamarkupfalse%
\ {\isacharparenleft}metis\ maximal{\isacharunderscore}on{\isacharunderscore}non{\isacharunderscore}strict{\isacharunderscore}def\ order{\isacharunderscore}on{\isacharunderscore}defs{\isacharparenleft}{\isadigit{1}}{\isacharparenright}\ preorder{\isacharunderscore}on{\isacharunderscore}finite{\isacharunderscore}non{\isacharunderscore}empty{\isacharunderscore}set{\isacharunderscore}has{\isacharunderscore}maximal\ refl{\isacharunderscore}onD{\isacharparenright}%
\endisatagproof
{\isafoldproof}%
%
\isadelimproof
...
\end{isabellebody}%
\endinput
%:%file=~/work/blockchain/LayerXcom/cbc-casper-proof/Isabelle/Libraries/Strict_Order.thy%:%
%:%6=5%:%
%:%7=6%:%
%:%12=7%:%
%:%13=7%:%
