...
module CBCCasper(Message, Set, equivocation, is_future_state) where {
...
newtype Message = Message (Map String String, (Map String String, [Message]));
...
sender :: Message -> Map String String;
sender (Message (uu, (v, uv))) = v;

equal_validator :: Map String String -> Map String String -> bool;
